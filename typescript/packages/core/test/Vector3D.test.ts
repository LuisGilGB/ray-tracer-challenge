...
describe('Vector tests', () => {
  describe('creation', () => {
    ...
    it('should create a vector from another vector', () => {
      const inputVector = new Vector3D(1, 2, 3);
      const outputVector = Vector3D.fromVector(inputVector);
    ...
    it('should create a vector from an object', () => {
      const vector = Vector3D.fromObject({x: 1, y: 2, z: 3});
      expect(vector.x).toBe(1);
      expect(vector.y).toBe(2);
      expect(vector.z).toBe(3);
    });
  ...
  describe('equality', () => {
    ...
    it('should not be equal to another vector with different coordinates', () => {
      const vector1 = new Vector3D(1, 2, 3);
      const vector2 = new Vector3D(1, 2, 4);
  ...
  describe('dot product', () => {
    it('should calculate the dot product of two vectors', () => {
      const vector1 = new Vector3D(1, 2, 3);
      const vector2 = new Vector3D(2, 3, 4);
